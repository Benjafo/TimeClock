...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const entries = isAdmin ? allEntries : allEntries.filter(e => e.discord_id === userId);
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(isAdmin ? 'Team members currently clocked in' : 'Your current status')
            .setTimestamp();
        ...
        embed.addFields({ name: 'Currently Working', value: statusText || 'No one is clocked in' });
